...
class RealFoxEdgeTPU(TFLiteDetectionPostProcessPredictor):

    LABELS = ["real_fox"]

    def __init__(
        self,
        model_name="real_fox_detector",
        tflite_file=rpi_deep_pantilt_path[0]
        + "/data/real_fox_edgetpu.tflite",  # substitute the FULL path to your .tflite file
